  ...
  try {
    ...
    const { data: { access_token } } = await axios({
      ...
      auth: {
        ...
        password: EFq6zhjSRVtsOj-xGAFppqBnaxmgmKbDgICSO36UzRQkXeyO1fW7DIOAKRCQm7-djc3pgcSJqvj3Z45J
      },
...
app.post('/submit-email', async (req, res) => {
  ...
  //respond immediatly before email sending
...
//   }
  ...
  transporter.sendMail(mailOptions, (error, info) => {
    if (error) {
      ...
      // You can log or handle this error further if needed
    } else {
